...
def main():
    ...
    #print(a_ind_group.groups.keys())
    #hhold_ids = a_ind_group.groups.keys()
    #print(hhold_ids)
    #print(len(a_train_ind.groupby('id').groups[24469]))
    #print(a_train_ind.groupby('id').groups[24469])

    #print(a_train_ind.groupby('id')['HeUgMnzF'].value_counts())
    #print(a_train_ind.groupby('id')[['HeUgMnzF']].agg(lambda x:x.value_counts().index[0]))
